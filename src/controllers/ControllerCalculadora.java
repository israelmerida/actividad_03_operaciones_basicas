...
public class ControllerCalculadora implements ActionListener {
    ...
    public void suma(){
        ...
        numero1 = Float.parseFloat(viewCalculadora.jtf_numero1.getText());
        numero2 = Float.parseFloat(viewCalculadora.jtf_numero2.getText());
        
        resultado = (numero1 )+ (numero2);
        viewCalculadora.jtf_resultado.setText(String.valueOf(resultado));
        viewCalculadora.jl_message.setText("" + (resultado));
    }
    public void resta(){
        float numero1= 0.0f;
        float numero2= 0.0f;
